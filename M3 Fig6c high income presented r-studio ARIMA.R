...
ARIMA  %>% 
  ...
  ggplot(aes(x=as.factor(year), y=high_income_presented_n))+
...
ARIMA %>% 
  ggplot(aes(x=month, y=high_income_presented_n))+
  geom_line()+
  labs(
    y = "Presented (n)"
  )
...
ARIMA  %>% 
  ...
  ggplot(aes(x=c_month, y=high_income_presented_n))+
  geom_line()+
  facet_wrap(~year)+
  labs(
    x = "Month",
...
Apr2012_Feb2022 <- ARIMA$high_income_presented_n[1:95]      

PANDEMIC2020_2022 <- ARIMA$high_income_presented_n[96:120]   
...
autoplot(Apr2012_Feb2022_ts) +  ylab("Presented (n)")
...
ggseasonplot(diff_Apr2012_Feb2022) + ylab("Presented (n)")

ggsubseriesplot(diff_Apr2012_Feb2022) +  ylab("Presented (n)")
...
ggplot(data = forecast_arima_Apr2012_Feb2022_df,
  ...
  ylim(0, 800)
ggsave("M3_6c.pdf", width = 15, height = 15)
...
ggplot(data = forecast_arima_Apr2012_Feb2022_df,
  ...
  theme(legend.position = "none") +  
  ylim(0, 200)
ggsave("M3_6c zoom.pdf", width = 15, height = 15)